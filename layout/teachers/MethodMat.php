    ...
    <body>
        ...
        <section class="SectionBodyHome">
            ...
            <div class="DivContentHome">
                <div class="Zagolovok">
                    <h1><?=$_GET['gr'];?>><?=$_GET['dis'];?>>Методический материал</h1>
                </div>
                <a href="AddFileMat.php?gr=<?=$_GET['gr']?>&dis=<?=$_GET['dis']?>&id_SL=<?=$_GET['id_SL']?>" class="Add">
                    <div>
                        <h3>Добавить файл</h3>
                    </div>
                </a>
                <div class="DivMBoxs_Mouth">
                        ...
                        while($taskRow=mysqli_fetch_array($taskResult, MYSQLI_ASSOC)){ ?>
                            ...
                            <?php
                                ...
                                while($rowDT=mysqli_fetch_array($resultDT, MYSQLI_ASSOC)){ ?>
                                    ...
                                    <a href="../../php/DeleteFile.php?id_DT=<?=$rowDT['id_DT']?>&gr=<?=$_GET['gr']?>&dis=<?=$_GET['dis']?>&id_SL=<?=$_GET['id_SL']?>" class="Del_file"><h3>Удалить файл</h3></a>
                                    </a></div>
                            <?php    }
                    ...
                    ?>
                    <!--<div class="BoxDate">
                        <h3>10 ноября 2020 года</h3>
                        <div></div>
                    </div>
                    <a href="#" id="aFile"><div class="BoxFile">
                        <p>Технические требования к созданию логотипа</p>
                        <span>10.11.2020</span>
                        <form action="" method="POST"><button type="submit" class="DeleteFile">Удалить</button></form>
                    </div></a>
                    <div class="BoxDate">
                        <h3>14 ноября 2020 года</h3>
                        <div></div>
                    </div>
                    <a href="#" id="aFile"><div class="BoxFile">
                        <p>Технические требования к созданию логобука</p>
