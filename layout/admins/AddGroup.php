        ...
        <section class="SectionBodyHome">
            <div class="LeftBar">
                ...
                <div class="DivAdminBar">
                    ...
                    <a href="AddGroup.php"><div id="BoxAdmin" class="ActiveBox3">
            ...
            <div class="DivContentHome">
                ...
                <div class="AddUser">
                    <form action="../../php/AddGroupBD.php" method="POST">
                        <div><p>Введите Название группы</p>
                        ...
                        <div>
                            <input type="submit" name="SaveUser1" value="Добавить группу">
                        </div>
                    </form>
                </div>
            </div>
