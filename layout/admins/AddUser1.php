        ...
        <section class="SectionBodyHome">
            <div class="LeftBar">
                ...
                <div class="DivAdminBar">
                    <a href="AddUser1.php"><div id="BoxAdmin" class="ActiveBox">
            ...
            <div class="DivContentHome">
                ...
                <div class="AddUser">
                    <form action="../../php/AddStudents.php" method="POST">
                        <div><p>Введите Фамилию студента</p>
                        <input type="text" name="fam">
                        </div>
                        <div><p>Введите Имя студента</p>
                        <input type="text" name="name">
                        </div>
                        <div><p>Введите Отчество студента</p>
                        ...
                        <div>
                            <input type="submit" name="SaveUser1" value="Добавить студента">
                        </div>
                    </form>
                </div>
            </div>
